...
const IndexPage = () => (
  <Layout>
    ...
    <div className="contentBlock">
      ...
      <p className="bodyCopy">Alacrán Studio was built to serve communities and elevate their brand. With organized processes, thoughtful design, the latest technology, and accessible consultants, we strive to grow your digital presence to get in front of the audience that matters to you.</p>
      <button className="primaryButton">schedule your free consultation</button>
    </div>
